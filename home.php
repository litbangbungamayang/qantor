<marquee><strong><h4>SELAMAT DATANG DI SISTEM APLIKASI SURAT PT BUMA CIMA NUSANTARA BANDAR LAMPUNG</strong></marquee></h4>
<?php
...
<!-- -->
     ...
     <!--<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php $jumlah_pimpinan = mysqli_query($koneksi, "select * from tb_asal_tujuan"); ?></h3>
